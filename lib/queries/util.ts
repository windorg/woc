...
export function updateQueryData<TData>(queryClient: QueryClient, queryKey: QueryKey, updater: (oldData: TData) => TData) {
...
export function updateQueriesData<TData>(queryClient: QueryClient, queryFilters: QueryFilters, updater: (oldData: TData) => TData) {
  // TODO: should cancel queries that are being fetched
